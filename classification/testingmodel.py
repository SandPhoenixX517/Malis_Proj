...
!wget https://gdo152.llnl.gov/cowc/download/cowc/datasets/patch_sets/detection/COWC_Detection_Columbus_CSUAV_AFRL.tbz
#!wget https://gdo152.llnl.gov/cowc/download/cowc/datasets/patch_sets/detection/COWC_Detection_Utah_AGRC.tbz

!wget https://gdo152.llnl.gov/cowc/download/cowc/datasets/patch_sets/detection/COWC_Detection_Potsdam_ISPRS.tbz
!wget https://gdo152.llnl.gov/cowc/download/cowc/datasets/patch_sets/detection/COWC_Detection_Selwyn_LINZ.tbz
#!wget https://gdo152.llnl.gov/cowc/download/cowc/datasets/patch_sets/detection/COWC_Detection_Vaihingen_ISPRS.tbz

!tar -xvjf ./COWC_Detection_Columbus_CSUAV_AFRL.tbz
!tar -xvjf ./COWC_Detection_Potsdam_ISPRS.tbz
!tar -xvjf ./COWC_Detection_Selwyn_LINZ.tbz
...
'''
nbr_img_train_columbus =  !ls ./Columbus_CSUAV_AFRL/train | wc -l
nbr_img_train_columbus = int(nbr_img_train_columbus[0])
nbr_img_test_columbus =  !ls ./Columbus_CSUAV_AFRL/test | wc -l
...
nbr_img_train_postdam =  !ls ./Potsdam_ISPRS/train | wc -l
nbr_img_train_postdam = int(nbr_img_train_postdam[0])
nbr_img_test_postdam =  !ls ./Potsdam_ISPRS/test | wc -l
...
# Postdam Cardinalities
nbr_img_train_selwyn =  !ls ./Selwyn_LINZ/train | wc -l
nbr_img_train_selwyn = int(nbr_img_train_selwyn[0])
nbr_img_test_selwyn =  !ls ./Selwyn_LINZ/test | wc -l
...
#model = train(model, train_dataloader,epochs=3, lr=LEARNING_RATE)
